...
```{r warning=FALSE}
# q <- ggplot(
#   covidnor::total[location_code=="nation_nor" & granularity_time=="day" & isoyear==2020], 
#   aes(
#     x = date, 
#     y = hospital_admissions_main_cause_n
#   )
# )
# q <- q + geom_col(width = 0.8, fill = csstyle::colors$base)
# q <- q + scale_x_date("Testing date")
